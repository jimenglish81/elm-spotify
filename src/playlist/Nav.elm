...
import Html.Attributes exposing (autofocus, class, href, placeholder, required, type_, value)
...
view model =
    ...
    [ nav []
      [ div [ class "nav-wrapper" ]
        [ ul []
          [ li []
            [ viewMaybe (loggedIn model.user) (loginBtn model.client) model.token ]
          ]
...
loggedIn user _ =
  case user of
    ...
    RemoteData.Success user ->
      div [ class "username" ] [ text user.id ]
...
loginBtn client =
    a
      ...
      ] [ i [ class "material-icons left" ] [ text "cloud" ], text "sign in" ]
